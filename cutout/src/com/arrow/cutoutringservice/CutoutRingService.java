...
public class CutoutRingService extends BroadcastReceiver {
    ...
    private static final String TAG = "CutoutRingServiceApollo";
    private static final String FRONT_CAMERA_ID = "1";

    private static final int RING_SIZE = 74;
    private static final int X_OFFSET = 55;
    private static final int X_OFFSET_HORIZONTAL = 24;
    private static final int Y_OFFSET = 24;
    private static final int Y_OFFSET_HORIZONTAL = 55;
